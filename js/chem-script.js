$(document).ready(function(){
    ...
    var myDataRef = new Firebase('https://chem-database.firebaseio.com/');
    ...
    */
      ...
      var ChemElemts = {};
      ChemElemts["Ac"] = "Actinium";
      ChemElemts["Al"] = "Aluminium";
      ChemElemts["Am"] = "Americium";
      ChemElemts["Sb"] = "Antimony";
      ChemElemts["Ar"] = "Argon";
      ChemElemts["As"] = "Arsenic";
      ChemElemts["At"] = "Astatine";
      ChemElemts["Ba"] = "Barium";
      ChemElemts["Be"] = "Berilium";
      ChemElemts["Bk"] = "Berkelium";
      ChemElemts["Bi"] = "Bismuth";
      ChemElemts["Bh"] = "Bohrium";
      ChemElemts["B"] = "Boron";
      ChemElemts["Br"] = "Bromine";
      ChemElemts["Cd"] = "Cadmium";
      ChemElemts["Cs"] = "Caesium";
      ChemElemts["Ca"] = "Calcium";
      ChemElemts["Cf"] = "Californium";
      ChemElemts["C"] = "Carbon";
      ChemElemts["Ce"] = "Cerium";
      ChemElemts["Cl"] = "Chlorine";
      ChemElemts["Cr"] = "Chromium";
      ChemElemts["Co"] = "Cobalt";
      ChemElemts["Cn"] = "Copernicium";
      ChemElemts["Cu"] = "Copper";
      ChemElemts["Cm"] = "Curium";
      ChemElemts["Ds"] = "Darmstadtium";
      ChemElemts["Db"] = "Dubnium";
      ChemElemts["Dy"] = "Dysprosium";
      ChemElemts["Es"] = "Einsteinium";
      ChemElemts["Er"] = "Erbium";
      ChemElemts["Eu"] = "Europium";
      ChemElemts["Fm"] = "Fermium";
      ChemElemts["Fl"] = "Flerovium";
      ChemElemts["F"] = "Fluor";
      ChemElemts["Fr"] = "Francium";
      ChemElemts["Gd"] = "Gadolium";
      ChemElemts["Ga"] = "Gallium";
      ChemElemts["Ge"] = "Germanium";
      ChemElemts["Au"] = "Gold";
      ChemElemts["Hf"] = "Hafnium";
      ChemElemts["Hs"] = "Hassium";
      ChemElemts["He"] = "Helium";
      ChemElemts["H"] = "Hidrogen";
      ChemElemts["Ho"] = "Homium";
      ChemElemts["In"] = "Indium";
      ChemElemts["I"] = "Iodine";
      ChemElemts["Ir"] = "Iridium";
      ChemElemts["Fe"] = "Iron";
      ChemElemts["Kr"] = "Krypton";
      ChemElemts["La"] = "Lanthanum";
      ChemElemts["Lr"] = "Lawrencium";
      ChemElemts["Pb"] = "Lead";
      ChemElemts["Li"] = "Lithium";
      ChemElemts["Lv"] = "Livermorium";
      ChemElemts["Lu"] = "Lutetium";
      ChemElemts["Mg"] = "Magnesium";
      ChemElemts["Mn"] = "Manganese";
      ChemElemts["Mt"] = "Meitnerium";
      ChemElemts["Md"] = "Mendelevium";
      ChemElemts["Hg"] = "Mercury";
      ChemElemts["Mo"] = "Molybdenum";
      ChemElemts["Nd"] = "Neodymium";
      ChemElemts["Ne"] = "Neon";
      ChemElemts["Np"] = "Neptunium";
      ChemElemts["Ni"] = "Nickel";
      ChemElemts["Nb"] = "Niobium";
      ChemElemts["N"] = "Nitrogen";
      ChemElemts["No"] = "Nobelium";
      ChemElemts["Os"] = "Osmium";
      ChemElemts["O"] = "Oxygen";
      ChemElemts["Pd"] = "Palladium";
      ChemElemts["P"] = "Phosphorus";
      ChemElemts["Pt"] = "Platinium";
      ChemElemts["Pu"] = "Plutonium";
      ChemElemts["Po"] = "Polonium";
      ChemElemts["K"] = "Potassium";
      ChemElemts["Pr"] = "Praseodymiym";
      ChemElemts["Pm"] = "Promethium";
      ChemElemts["Pa"] = "Protactinium";
      ChemElemts["Ra"] = "Radium";
      ChemElemts["Rn"] = "Radon";
      ChemElemts["Re"] = "Rhedium";
      ChemElemts["Rh"] = "Rhodium";
      ChemElemts["Rg"] = "Roengenium";
      ChemElemts["Rb"] = "Rubidium";
      ChemElemts["Ru"] = "Ruthenium";
      ChemElemts["Rf"] = "Rutherfordium";
      ChemElemts["Sm"] = "Samarium";
      ChemElemts["Sc"] = "Scandium";
      ChemElemts["Sg"] = "Seaborguim";
      ChemElemts["Se"] = "Selenium";
      ChemElemts["Si"] = "Silicon";
      ChemElemts["Ag"] = "Silver";
      ChemElemts["Na"] = "Sodium";
      ChemElemts["Sr"] = "Strontium";
      ChemElemts["S"] = "Sulfur";
      ChemElemts["Ta"] = "Tantalum";
      ChemElemts["Tc"] = "Technetium";
      ChemElemts["Te"] = "Tellurium";
      ChemElemts["Tb"] = "Terbium";
      ChemElemts["Tl"] = "Thallium";
      ChemElemts["Th"] = "Thorium";
      ChemElemts["Tm"] = "Thulium";
      ChemElemts["Sn"] = "Tin";
      ChemElemts["Ti"] = "Titanium";
      ChemElemts["W"] = "Tungsten";
      ChemElemts["Ubn"] = "Unbinilium";
      ChemElemts["Uue"] = "Ununennium";
      ChemElemts["Uuo"] = "Ununoctium";
      ChemElemts["Uup"] = "Ununpentium";
      ChemElemts["Uus"] = "Ununseptium";
      ChemElemts["Uut"] = "Ununtrium";
      ChemElemts["U"] = "Uranium";
      ChemElemts["V"] = "Vanadium";
      ChemElemts["Xe"] = "Xenon";
      ChemElemts["Yb"] = "Ytterbium";
      ChemElemts["Y"] = "Yttrium";
      ChemElemts["Zn"] = "Zinc";
      ChemElemts["Zr"] = "Zirconium";
      /*ChemElemts[""] = "";
      ChemElemts[""] = "";
      ChemElemts[""] = "";
      ChemElemts[""] = "";
    ...
    /*
      Function Database SSearch Atomic Weight
    */
    function DatabaseSearchAW(e,elmF) {
      e.preventDefault();
      var AE = 0;
       myDataRef.on('value', function(data){
           if(data.val()[elmF] != undefined){
              var AtWgD = data.val()[elmF]['Atomic Weight'];
              return AtWgD
    ...
    */
    ...
    function IsMayus(str,pos) {
      var state = str[pos].toUpperCase() === str[pos];
      return state;
    }
    ...
    */
    ...
    $('#kg').click(function(){
        mass = $('input[name=QuantityMass1]').val();
        massN = parseFloat(mass);
        massU = $('input[name=UnitsMass1]').val();

        if(massN >= 0){
            if(massU == 'Kg' || massU == 'kg'){
                $('#ResultMass').html(massN.toFixed(4) +' Kg');
            } if(massU == 'g' || massU == 'G' || massU == 'gr' || massU == 'Gr' || massU == 'GR'){
                $('#ResultMass').html((massN/1000).toFixed(4) +' Kg');
          }

        } if(massN < 0 || mass == '1/0'){
            $('#ResultMass').html('ERROR');
        }
    });
    ...
    $('#g').click(function(){
        ...
        if(massN >= 0){
          if(massU == 'Kg' || massU == 'kg'){
              $('#ResultMass').html((massN*1000).toFixed(4) +' g');
          } if(massU == 'g' || massU == 'G' || massU == 'gr' || massU == 'Gr' || massU == 'GR'){
              $('#ResultMass').html(massN.toFixed(4) +' g');
          }
        }
        if(massN < 0 || massN == '1/0'){
            $('#ResultMass').html('ERROR');
        }
    ...
    */
       ...
       $('#K').click(function(){
        temp = $('input[name=QuantityTemperature1]').val();
        tempN = parseFloat(temp);
        tempU = $('input[name=UnitsTemperature1]').val();
          if(tempU == 'K' || tempU == 'k'){
              $('#ResultTemperature').html(tempN.toFixed(4) +' K');
          } if(tempU == 'C' || tempU == 'c'){
              $('#ResultTemperature').html((tempN + 273.15).toFixed(4)+ ' K'  );
          } if(tempU == 'F' || tempU == 'f'){
               $('#ResultTemperature').html(((tempN + 459.67)*(5/9)).toFixed(4)+ ' K'  );
          }
    ...
    $('#C').click(function(){
        ...
        tempU = $('input[name=UnitsTemperature1]').val();
          if(tempU == 'K' || tempU == 'k'){
              $('#ResultTemperature').html((tempN - 273.15).toFixed(4) +' °C');
          } if(tempU == 'C' || tempU == 'c'){
              $('#ResultTemperature').html((tempN).toFixed(4)+ ' °C');
          } if(tempU == 'F' || tempU == 'f'){
               $('#ResultTemperature').html(((tempN + 32)*(5/9)).toFixed(4)+ ' °C');
          }
    ...
    $('#F').click(function(){
        ...
        tempU = $('input[name=UnitsTemperature1]').val();
          if(tempU == 'K' || tempU == 'k'){
              $('#ResultTemperature').html(((tempN + 459.67)*(5/9)).toFixed(4) +' °F');
          } if(tempU == 'C' || tempU == 'c'){
              $('#ResultTemperature').html(((tempN * 9/5) + 32).toFixed(4)+ ' °F');
          } if(tempU == 'F' || tempU == 'f'){
               $('#ResultTemperature').html((tempN).toFixed(4)+ ' °F');
          }
    ...
    */
    ...
    $('#L').click(function(){
        Vol = $('input[name=QuantityVolume1]').val();
        VolN = parseFloat(Vol);
        VolU = $('input[name=UnitsVolume1]').val();
            if(VolU == 'L' || VolU == 'l'){
                $('#ResultVolume').html(VolN.toFixed(4) + ' L');
            }
            if(VolU == 'mL' || VolU == 'ML' || VolU == 'Ml' || VolU == 'ml'){
              $('#ResultVolume').html((VolN/1000).toFixed(4) + ' L');
            }
            if(VolU == 'cm3' || VolU == 'Cm3' || VolU == 'cM3' || VolU == 'CM3'){
                $('#ResultVolume').html((VolN/1000).toFixed(4) + ' L');
            }
            if(VolU == 'm3' || VolU == 'M3'){
                $('#ResultVolume').html((VolN).toFixed(4) + ' L');
            }
            if(VolU == 'ft3' || VolU == 'Ft3' || VolU == 'fT3' || VolU == 'FT3'){
                $('#ResultVolume').html((VolN*28.3168).toFixed(4) + ' mL');
            }
    });
        ...
        VolU = $('input[name=UnitsVolume1]').val();
            if(VolU == 'L' || VolU == 'l'){
                $('#ResultVolume').html((VolN*1000).toFixed(4) + ' mL');
            }
            if(VolU == 'mL' || VolU == 'ML' || VolU == 'Ml' || VolU == 'ml'){
              $('#ResultVolume').html(VolN.toFixed(4) + ' mL');
            }
            if(VolU == 'cm3' || VolU == 'Cm3' || VolU == 'cM3' || VolU == 'CM3'){
                $('#ResultVolume').html(VolN.toFixed(4) + ' mL');
            }
            ...
            if(VolU == 'ft3' || VolU == 'Ft3' || VolU == 'fT3' || VolU == 'FT3'){
                $('#ResultVolume').html((VolN*28316.8).toFixed(4) + ' mL');
            }
    });
        ...
        VolU = $('input[name=UnitsVolume1]').val();
            if(VolU == 'L' || VolU == 'l'){
                $('#ResultVolume').html((VolN/1000).toFixed(4) + ' cm&sup3;');
            }
            if(VolU == 'mL' || VolU == 'ML' || VolU == 'Ml' || VolU == 'ml'){
              $('#ResultVolume').html(VolN.toFixed(4) + ' cm&sup3;');
            }
            if(VolU == 'cm3' || VolU == 'Cm3' || VolU == 'cM3' || VolU == 'CM3'){
                $('#ResultVolume').html(VolN.toFixed(4) + ' cm&sup3;');
            }
            ...
            if(VolU == 'ft3' || VolU == 'Ft3' || VolU == 'fT3' || VolU == 'FT3'){
                $('#ResultVolume').html((VolN*28316.8).toFixed(4) + ' cm&sup3;');
            }
    });
        ...
        VolU = $('input[name=UnitsVolume1]').val();
            if(VolU == 'L' || VolU == 'l'){
                $('#ResultVolume').html(VolN.toFixed(4) + ' m&sup3;');
            }
            if(VolU == 'mL' || VolU == 'ML' || VolU == 'Ml' || VolU == 'ml'){
              $('#ResultVolume').html((VolN*1000).toFixed(4) + ' m&sup3;');
            }
            if(VolU == 'cm3' || VolU == 'Cm3' || VolU == 'cM3' || VolU == 'CM3'){
                $('#ResultVolume').html((VolN*1000).toFixed(4) + ' m&sup3;');
            }
            ...
            if(VolU == 'ft3' || VolU == 'Ft3' || VolU == 'fT3' || VolU == 'FT3'){
                $('#ResultVolume').html((VolN*28.3168).toFixed(4) + ' m&sup3;');
            }
    });
        ...
        VolU = $('input[name=UnitsVolume1]').val();
            if(VolU == 'L' || VolU == 'l'){
                $('#ResultVolume').html((VolN*0.0353).toFixed(4) + ' ft&sup3;');
            }
            if(VolU == 'mL' || VolU == 'ML' || VolU == 'Ml' || VolU == 'ml'){
              $('#ResultVolume').html((VolN*0.000035315).toFixed(4) + ' ft&sup3;');
            }
            if(VolU == 'cm3' || VolU == 'Cm3' || VolU == 'cM3' || VolU == 'CM3'){
                $('#ResultVolume').html((VolN*0.000035315).toFixed(4) + ' ft&sup3;');
            }
            ...
            if(VolU == 'ft3' || VolU == 'Ft3' || VolU == 'fT3' || VolU == 'FT3'){
                $("#ResultVolume").html(VolN.toFixed(4) + " ft&sup3;");
            }
    });
    ...
    */
    ...
    $('#Mol').click(function() {
        Grms = $('#QuantityMassMol').val();
        GrmsN = parseFloat(Grms);
        ChemF = $('#InputChemFormula').val();
        var atomsM = [];
        var atomsN = [];
        var atomsW = [];
        var Fpos;
        ...
        console.log(GrmsN);
        for (var i = 0;i<ChemF.length;i++){
            if(isNaN(ChemF[i]) === false){
                atomsM.push(ChemF.substring(Fpos,(i+1)));
                Fpos = i;
            } else if (IsMayus(ChemF,i) === true) {
              atomsM.push(ChemF.substring(Fpos,(i+1)));
              Fpos = i;
            }

            atomsM.forEach(function (CF) {
              var len = CF.length;
              if (len == 1) {
                Apos++;
                //Buscar Elemento en Database 1L
                AtWg = DatabaseSearchAW(e,ChemElemts[CF]);
                atomsW.push(AtWg);
              } else if (len == 2) {
                if (isNaN(CF[1]) === true) {
                  Apos++;
                  //Buscar Elemento en Database 2L
                  AtWg = DatabaseSearchAW(e,ChemElemts[CF]);
                  atomsW.push(AtWg);
                } else {
                  Apos++;
                  AtWg = DatabaseSearchAW(e,CF.substring(0,1)) //Buscar Elemento en Database 1L
                  atomsW.push(AtWg*CF.substring(1));
    ...
    /*
            Codigo Element Database
    */

    $('#SearchELement').click(function(e){
        var elm = $("#ChemElement").val().toLowerCase();
        elm = elm.charAt(0).toUpperCase() + elm.slice(1);
        e.preventDefault();
         myDataRef.on('value', function(data){
             if(data.val()[elm] != undefined){
                var AtWg = data.val()[elm]['Atomic Weight'];
                var Sym = data.val()[elm]['Symbol'];
                $('#ResultDataWeight').html('Atomic Weight: ' + AtWg + ' gr/mol');
                $('#ResultDataSymbol').html('Symbol: ' + Sym);
                console.log('holiwis');
                console.log(AtWg +' '+Sym);
                console.log(elm);
                console.log('3');

             } else{
                $('#ResultDataWeight').html('ERROR');
                $('#ResultDataSymbol').html('ERROR');
                console.log('chaiwis');
            }
         });
    });
    ...
    /*
      Codigo Balanceador ..... For License reference "License Nayuki.js"
    */


"use strict";
$("#balancea").click(function(e){
	e.preventDefault()
	balance($("#inputFormula").val());
})
$("#randomiza").click(function(e){
	e.preventDefault()
	random();
})
